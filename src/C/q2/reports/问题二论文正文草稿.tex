...
%  论文正文开始
% ============================================================
\newcommand{\PaperTitle}{问题二：视觉刺激到头皮脑电的正向计算模型}
...
\tightlist
\item
  输入图像矩阵及共同背景矩阵代表模型使用的视觉亮度结构；左右提示的相对差分保留明暗符号与空间位置。
\item
  VisCue对齐的提示起点取0 ms，提示显示区间按代码设置为\([0,200)\) ms。提示消失后，LGN和皮层状态按方程自然衰减。
\item
  三组兴奋-抑制活动和五个源均作为低维功能代理；它们刻画模型计算路径，不赋予具体解剖脑区含义。
\item
  电极和乳突参考使用规范头坐标及固定点偶极近似。源坐标、方向和导电率采用统一设定，不从留出记录重新估计。
\item
  外层验证单位为MAT记录。四份文件没有可核实的受试者身份，因此结果只称记录留出验证。
\item
  问题二主模型模拟提示输入，不在约2.2 s加入目标刺激。模型输出与真实完整试次的晚期信号比较时，保留该事件上下文差异作为解释限制。
\end{enumerate}
...
\hypertarget{ux6570ux636eux4e0eux89c6ux89c9ux523aux6fc0ux7f16ux7801}{%
\section{数据与视觉刺激编码}\label{ux6570ux636eux4e0eux89c6ux89c9ux523aux6fc0ux7f16ux7801}}

实测脑电取自第一问清洗后的四份MAT记录，按通道标签重排为F3、Fz、F4，采样率为128 Hz。每个提示试次先减去提示前\([-200,0)\) ms均值，再计算条件平均ERP。可用于左右提示分析的试次如下。

\textbf{表2 Stage1左右提示试次数}
...
\begin{figure}
\centering
\includegraphics[width=0.96\textwidth,height=\textheight]{../documents/figures/视觉刺激与前端空间特征.png}
\caption{左右视觉提示与前端空间特征}
\end{figure}

\hypertarget{ux6b63ux5411ux8111ux7535ux8ba1ux7b97ux6a21ux578b}{%
\section{正向脑电计算模型}\label{ux6b63ux5411ux8111ux7535ux8ba1ux7b97ux6a21ux578b}}

\hypertarget{lgn-onoffux4e2dux7ee7}{%
\subsection{LGN ON/OFF中继}\label{lgn-onoffux4e2dux7ee7}}
...
\hypertarget{gaborux65b9ux5411ux4e0eux4e09ux89d2ux6784ux578bux7f16ux7801}{%
\subsection{Gabor方向与三角构型编码}\label{gaborux65b9ux5411ux4e0eux4e09ux89d2ux6784ux578bux7f16ux7801}}
...
\begin{figure}
\centering
\includegraphics[width=0.96\textwidth,height=\textheight]{../documents/figures/revision_v3_真实数据与皮层观测模块IO.png}
\caption{视觉输入、皮层状态、源代理与头皮观测}
\end{figure}

\hypertarget{ux4e09ux7ec4ux5174ux594b-ux6291ux5236ux7fa4ux4f53ux52a8ux529bux5b66}{%
\subsection{三组兴奋-抑制群体动力学}\label{ux4e09ux7ec4ux5174ux594b-ux6291ux5236ux7fa4ux4f53ux52a8ux529bux5b66}}
...
\hypertarget{ux4e94ux6e90ux4ee3ux7406ux4e0eux5934ux76aeux6b63ux5411ux6620ux5c04}{%
\subsection{五源代理与头皮正向映射}\label{ux4e94ux6e90ux4ee3ux7406ux4e0eux5934ux76aeux6b63ux5411ux6620ux5c04}}
...
\hypertarget{ux53c2ux6570ux4f30ux8ba1ux4e0eux9a8cux8bc1ux8bbeux8ba1}{%
\section{参数估计与验证设计}\label{ux53c2ux6570ux4f30ux8ba1ux4e0eux9a8cux8bc1ux8bbeux8ba1}}
...
\hypertarget{ux6a21ux578bux5185ux5de6ux53f3ux5deeux5f02ux53caux6570ux503cux6838ux67e5}{%
\subsection{模型内左右差异及数值核查}\label{ux6a21ux578bux5185ux5de6ux53f3ux5deeux5f02ux53caux6570ux503cux6838ux67e5}}
...
\begin{figure}
\centering
\includegraphics[width=0.96\textwidth,height=\textheight]{../documents/figures/实测与模型左右差异模式.png}
\caption{实测与模型左右差异模式}
\end{figure}

\hypertarget{ux7559ux51faerpux62dfux5408}{%
\subsection{留出ERP拟合}\label{ux7559ux51faerpux62dfux5408}}
...
\begin{figure}
\centering
\includegraphics[width=0.96\textwidth,height=\textheight]{../documents/figures/留一记录实测与模型ERP.png}
\caption{留一记录实测ERP与模型预测}
\end{figure}

\Needspace{12\baselineskip}

\hypertarget{ux4e5dux7ef4ux8111ux7535ux7279ux5f81ux53caux5206ux7c7bux7ed3ux679c}{%
\subsection{九维脑电特征及分类结果}\label{ux4e5dux7ef4ux8111ux7535ux7279ux5f81ux53caux5206ux7c7bux7ed3ux679c}}

\textbf{表6 九维固定特征的留一记录分类}
...
\begin{figure}
\centering
\includegraphics[width=0.96\textwidth,height=\textheight]{../documents/figures/九维ERP特征_留一记录分类.png}
\caption{九维ERP特征留一记录分类}
\end{figure}
